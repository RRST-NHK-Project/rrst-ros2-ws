...
namespace r1_planner {
    ...
    TaskManagerNode::TaskManagerNode()
        ...
        declare_parameter<std::string>("mff_path_topic", "r1/task_mff_path");
        declare_parameter<std::string>("mff_path_advance_topic", "r1/task_mff_path_advance");
        declare_parameter<std::string>("mff_turn_cmd_topic", "r1_mff_turn_cmd");
        declare_parameter<std::string>("mff_step_cmd_topic", "r1_mff_step_cmd");
        declare_parameter<std::string>("mff_status_topic", "r1/task_mff_status");
