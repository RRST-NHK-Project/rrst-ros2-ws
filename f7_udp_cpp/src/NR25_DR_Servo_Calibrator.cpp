...
// ファイルのフルパス
const std::string PARAM_FILE = BASE_DIR + "/dr_servo_cal.json";
const std::string CSV_FILE = BASE_DIR + "/dr_servo_cal.csv";

class ParameterNode : public rclcpp::Node {
public:
    ParameterNode() : Node("dr_servo_cal"), shoot_state(0), dribble_state(0) {
