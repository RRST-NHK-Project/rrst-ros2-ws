...
// ファイルのフルパス
const std::string PARAM_FILE = BASE_DIR + "/dr_parameter.json";
const std::string CSV_FILE = BASE_DIR + "/dr_parameter.csv";
...
private:
    ...
    void show_parameters() {
        std::cout << "\n=== Current Parameters ===\n";
        std::cout << "0: motor1 = " << params[0] << "\n";
        std::cout << "1: motor2 = " << params[1] << "\n";
        std::cout << "2: motor3   = " << params[2] << "\n";
        std::cout << "3: motor4   = " << params[3] << "\n";
