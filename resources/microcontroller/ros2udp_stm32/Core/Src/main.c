...
/* Definitions for udpReceiveTask */
osThreadId_t udpReceiveTaskHandle;
const osThreadAttr_t udpReceiveTask_attributes = {
  .name = "udpReceiveTask",
  .stack_size = 1024 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/**
* @brief Function implementing the udpReceiveTask thread.
* @param argument: Not used
* @retval None
*/
