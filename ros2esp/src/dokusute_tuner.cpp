...
// ファイルのフルパス
const std::string PARAM_FILE = BASE_DIR + "/dokusute_parameter.json";
const std::string CSV_FILE = BASE_DIR + "/dokusute_parameter.csv";

class ParameterNode : public rclcpp::Node
{
public:
    ParameterNode() : Node("dokusute_tuner")
    {
...
private:
    ...
    {
        std::cout << "\n=== Current Parameters ===\n";
        std::cout << "0: 前進速度 = " << params[0] << "\n";
        std::cout << "1: 回転速度 = " << params[1] << "\n";
        std::cout << "2: desired_speed = " << params[2] << "\n";
        std::cout << "3: LATERALMOTION_speed  = " << params[3] << "\n";
        std::cout << "==========================\n";
    }
};
